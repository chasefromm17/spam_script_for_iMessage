...
**NOTICE FOR MACOS MOJAVE USERS**: This script was NOT tested on macOS Mojave. Please either test yourself or just allow for adequate testing with due time on my end. I need to buy an MacBook Pro 2014 and 15" to test with macOS Mojave installed before I can test it with AppleScript, Xcode, iMessage, etc anyway for Christmas and if you can wait, that'd be appreciated.
